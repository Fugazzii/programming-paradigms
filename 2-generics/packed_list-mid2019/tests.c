...
int main(int argc, char* argv[]) {
  ...
  RUN_TEST(PL_Empty, &opts);
  RUN_TEST(PL_Ints_Basic, &opts);
  RUN_TEST(PL_Ints_Sort, &opts);
  RUN_TEST(PL_CStrings, &opts);
  RUN_TEST(PL_CStrings_Sort, &opts);
  RUN_TEST(IP_Empty, &opts);
  RUN_TEST(IP_IPv4, &opts);
  RUN_TEST(IP_IPv4_Sort, &opts);
  RUN_TEST(IP_IPv6, &opts);
  RUN_TEST(IP_IPv6_Sort, &opts);
  RUN_TEST(IP_IPvMix, &opts);
  RUN_TEST(IP_IPvMix_Sort, &opts);
  return 0;
}
